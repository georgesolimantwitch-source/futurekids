        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {app.productFeatures.map((feature, index) => (
            <AnimateOnScroll key={feature.title} delay={index * 60}>
              <article className="group h-full rounded-2xl border border-neutral-100 bg-[#fafafa] p-8 transition-all duration-300 hover:-translate-y-1 hover:border-neutral-200 hover:shadow-md">
                <div
                  className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl text-sm font-bold text-white transition-transform duration-300 group-hover:scale-110"
